...
#include "my_robot_interfaces/msg/detail/turtle_status__rosidl_typesupport_fastrtps_c.h"
...
using _TurtleStatus__ros_msg_type = my_robot_interfaces__msg__TurtleStatus;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _TurtleStatus__ros_msg_type * ros_message = static_cast<const _TurtleStatus__ros_msg_type *>(untyped_ros_message);
  // Field name: distance_to_wall
  {
  ...
  void * untyped_ros_message)
{
  ...
  _TurtleStatus__ros_msg_type * ros_message = static_cast<_TurtleStatus__ros_msg_type *>(untyped_ros_message);
  // Field name: distance_to_wall
  {
    cdr >> ros_message->distance_to_wall;
  }
...
size_t get_serialized_size_my_robot_interfaces__msg__TurtleStatus(
  const void * untyped_ros_message,
...
static uint32_t _TurtleStatus__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_my_robot_interfaces__msg__TurtleStatus(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_robot_interfaces
size_t max_serialized_size_my_robot_interfaces__msg__TurtleStatus(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = my_robot_interfaces__msg__TurtleStatus;
    is_plain =
      (
...
static size_t _TurtleStatus__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_my_robot_interfaces__msg__TurtleStatus(
...
static message_type_support_callbacks_t __callbacks_TurtleStatus = {
...
static rosidl_message_type_support_t _TurtleStatus__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_TurtleStatus,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_robot_interfaces, msg, TurtleStatus)() {
  return &_TurtleStatus__type_support;
}
