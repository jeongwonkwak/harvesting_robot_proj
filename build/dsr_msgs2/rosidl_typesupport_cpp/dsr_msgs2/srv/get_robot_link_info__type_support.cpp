...
static const _GetRobotLinkInfo_Request_type_support_symbol_names_t _GetRobotLinkInfo_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dsr_msgs2, srv, GetRobotLinkInfo_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dsr_msgs2, srv, GetRobotLinkInfo_Request)),
  }
};
...
{
  return &::dsr_msgs2::srv::rosidl_typesupport_cpp::GetRobotLinkInfo_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, dsr_msgs2, srv, GetRobotLinkInfo_Request)() {
  return get_message_type_support_handle<dsr_msgs2::srv::GetRobotLinkInfo_Request>();
}
...
static const _GetRobotLinkInfo_Response_type_support_symbol_names_t _GetRobotLinkInfo_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dsr_msgs2, srv, GetRobotLinkInfo_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dsr_msgs2, srv, GetRobotLinkInfo_Response)),
  }
};
...
{
  return &::dsr_msgs2::srv::rosidl_typesupport_cpp::GetRobotLinkInfo_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, dsr_msgs2, srv, GetRobotLinkInfo_Response)() {
  return get_message_type_support_handle<dsr_msgs2::srv::GetRobotLinkInfo_Response>();
}
...
static const _GetRobotLinkInfo_type_support_symbol_names_t _GetRobotLinkInfo_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dsr_msgs2, srv, GetRobotLinkInfo)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dsr_msgs2, srv, GetRobotLinkInfo)),
  }
};
...
{
  return &::dsr_msgs2::srv::rosidl_typesupport_cpp::GetRobotLinkInfo_service_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, dsr_msgs2, srv, GetRobotLinkInfo)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<dsr_msgs2::srv::GetRobotLinkInfo>();
}
