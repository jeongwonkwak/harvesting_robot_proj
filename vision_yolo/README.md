...
> 이 폴더는 `harvesting_robot_miniproj` 모노레포의 **vision_yolo** 패키지입니다.  
> 경로·동기화 요약: [README_VISION_YOLO.md](README_VISION_YOLO.md)  
> 원본 개발 repo에서 올릴 때: `~/yolo_strawberry` → `bash scripts/sync_to_vision_yolo.sh`
